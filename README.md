...
├── pretrained/                     ← run download_weights.sh or train from scratch, partially gitignored
│   └── download_weights.sh
...
```bibtex
@misc{sail2026,
  title     = {SAIL: Sparse Autoencoders for Interpretable Medical Image Representation Learning},
  author    = {[Authors]},
  year      = {2026}
}
```